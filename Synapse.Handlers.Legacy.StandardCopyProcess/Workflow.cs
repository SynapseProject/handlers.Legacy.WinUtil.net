...
namespace Synapse.Handlers.Legacy.StandardCopyProcess
{
    public class Workflow
    {
        ...
        public void ExecuteAction(HandlerStartInfo startInfo)
        {
            ...
            OnStepFinished( context, msg, status, _startInfo.InstanceId, int.MaxValue, ex );
        }
        ...
        /// <param name="message">Descriptive message.</param>
        void OnStepFinished(string context, string message, Exception ex = null)
        {
            OnStepFinished( context, message, StatusType.Running, _startInfo.InstanceId, _cheapSequence++, ex );
        }

        void OnStepFinished(string context, string message, StatusType status, long instanceId, int sequence, Exception ex)
        {
            OnLogMessage( context, message, ex == null ? LogLevel.Info : LogLevel.Error, ex );
            OnProgress( context, message, status, instanceId, sequence, false, ex );
        }
